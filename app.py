...
@app.route('/form_paty', methods=['GET', 'POST'])
def form_paty():
    form = HelloForm()
    return render_template('form_paty.html', form=form, telephone_form=TelephoneForm(), contact_form=ContactForm(), im_form=IMForm())
